...
def passport_string_to_dict(passport_as_string: str) -> Dict[str, str]:
...
def count_number_of_valid_passports(
        passports: List[Dict[str, str]], important_fields: List[str]) -> int:
...
def is_valid_passport(
        passport: Dict[str, str], important_fields: List[str]) -> bool:
